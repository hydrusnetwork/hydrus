...
class TestDownloaders( unittest.TestCase ):
    ...
    def test_pixiv( self ):
        ...
        wx.GetApp().GetHTTP().SetResponse( HC.GET, 'http://www.pixiv.net/member_illust.php?mode=medium&illust_id=43718605', pixiv_page )
        
        wx.GetApp().GetHTTP().SetResponse( HC.GET, 'http://i1.pixiv.net/img59/img/dbhope/43718605.jpg', 'image file' )
    ...
    def test_booru_e621( self ):
        ...
        wx.GetApp().GetHTTP().SetResponse( HC.GET, 'http://e621.net/post/index?page=1&tags=flash', e621_gallery )
        wx.GetApp().GetHTTP().SetResponse( HC.GET, 'http://e621.net/post/show/360338/2013-3_toes-anal-anal_penetration-animated-argonia', e621_page )
        ...
        wx.GetApp().GetHTTP().SetResponse( HC.GET, 'https://static1.e621.net/data/f5/48/f54897c2543e0264e1a64d7f7c33c9f9.swf', 'swf file' )
