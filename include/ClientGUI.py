...
class FrameSplash( ClientGUICommon.Frame ):
    ...
    def __init__( self ):
        ...
        HydrusGlobals.client_controller.sub( self, 'SetTitleText', 'splash_set_title_text' )
        HydrusGlobals.client_controller.sub( self, 'SetStatusText', 'splash_set_status_text' )
