...
class TestSessions( unittest.TestCase ):
    ...
    def test_server( self ):
        ...
        discard = HydrusGlobals.controller.GetWrite( 'session' ) # just to discard gumph from testserver
        ...
        HydrusGlobals.controller.SetRead( 'sessions', [ ( session_key_1, service_key, account, expires ) ] )
        ...
        HydrusGlobals.controller.SetRead( 'account_key_from_access_key', account_key_2 )
        HydrusGlobals.controller.SetRead( 'account', account_2 )
        
        ( session_key_2, expires_2 ) = session_manager.AddSession( service_key, access_key )
        
        [ ( args, kwargs ) ] = HydrusGlobals.controller.GetWrite( 'session' )
        ...
        HydrusGlobals.controller.SetRead( 'account_key_from_access_key', account_key )
        HydrusGlobals.controller.SetRead( 'account', account )
        ...
        HydrusGlobals.controller.SetRead( 'account', updated_account )
        ...
        HydrusGlobals.controller.SetRead( 'sessions', [ ( session_key_1, service_key, updated_account_2, expires ), ( session_key_2, service_key, account_2, expires ), ( session_key_3, service_key, updated_account_2, expires ) ] )
