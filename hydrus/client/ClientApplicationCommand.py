...
SIMPLE_WINDOW_AUDIO_MUTE = 204
SIMPLE_WINDOW_AUDIO_MUTE_FLIP = 205
SIMPLE_WINDOW_AUDIO_UNMUTE = 206
...
simple_enum_to_str_lookup = {
    ...
    SIMPLE_WINDOW_AUDIO_MUTE : 'window audio: mute',
    SIMPLE_WINDOW_AUDIO_MUTE_FLIP : 'window audio: mute/unmute',
    SIMPLE_WINDOW_AUDIO_UNMUTE : 'window audio: unmute',
...
legacy_simple_str_to_enum_lookup = {
    ...
    'window_audio_mute' : SIMPLE_WINDOW_AUDIO_MUTE,
    'window_audio_mute_flip' : SIMPLE_WINDOW_AUDIO_MUTE_FLIP,
    'window_audio_unmute' : SIMPLE_WINDOW_AUDIO_UNMUTE,
