...
pred_generators = {
    ...
    SystemPredicateParser.Predicate.HAS_XMP : lambda o, v, u: ClientSearchPredicate.Predicate( ClientSearchPredicate.PREDICATE_TYPE_SYSTEM_HAS_XMP, True ),
    SystemPredicateParser.Predicate.NO_XMP : lambda o, v, u: ClientSearchPredicate.Predicate( ClientSearchPredicate.PREDICATE_TYPE_SYSTEM_HAS_XMP, False ),
    SystemPredicateParser.Predicate.HAS_IPTC : lambda o, v, u: ClientSearchPredicate.Predicate( ClientSearchPredicate.PREDICATE_TYPE_SYSTEM_HAS_IPTC, True ),
    SystemPredicateParser.Predicate.NO_IPTC : lambda o, v, u: ClientSearchPredicate.Predicate( ClientSearchPredicate.PREDICATE_TYPE_SYSTEM_HAS_IPTC, False ),
    ...
    SystemPredicateParser.Predicate.HAS_SOFTWARE_SOURCE : lambda o, v, u: ClientSearchPredicate.Predicate( ClientSearchPredicate.PREDICATE_TYPE_SYSTEM_HAS_SOFTWARE_SOURCE, True ),
    SystemPredicateParser.Predicate.NO_SOFTWARE_SOURCE : lambda o, v, u: ClientSearchPredicate.Predicate( ClientSearchPredicate.PREDICATE_TYPE_SYSTEM_HAS_SOFTWARE_SOURCE, False ),
