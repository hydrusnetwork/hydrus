...
CLIENT_API_PERMISSION_MANAGE_FAVOURITE_TAGS = 14
...
ALLOWED_PERMISSIONS = (
    ...
    CLIENT_API_PERMISSION_MANAGE_FAVOURITE_TAGS
)
...
basic_permission_to_str_lookup = {
    ...
    CLIENT_API_PERMISSION_MANAGE_FAVOURITE_TAGS : 'manage favourite tags'
}
