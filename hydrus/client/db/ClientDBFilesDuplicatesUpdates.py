...
class ClientDBFilesDuplicatesUpdates( ClientDBModule.ClientDBModule ):
    ...
    def AddPotentialDuplicates( self, media_id, potential_duplicate_media_ids_and_distances ):
        ...
        # I previously did 'FileIsInPairDiscoverySearch' here, but that's wrong; we want to test if the file is local, not that it is registered for search. the latter is a subset of the former
