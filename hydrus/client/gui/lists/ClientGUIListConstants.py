...
class COLUMN_LIST_OPEN_EXTERNALLY( COLUMN_LIST_DEFINITION ):
...
register_column_type( COLUMN_LIST_EXTERNAL_PROGRAMS.ID, COLUMN_LIST_EXTERNAL_PROGRAMS.NAME, 'name', False, 30, True )
register_column_type( COLUMN_LIST_EXTERNAL_PROGRAMS.ID, COLUMN_LIST_EXTERNAL_PROGRAMS.PIPELINE_TYPE, 'type', False, 30, True )
register_column_type( COLUMN_LIST_EXTERNAL_PROGRAMS.ID, COLUMN_LIST_EXTERNAL_PROGRAMS.COMMAND_DESCRIPTION, 'command', False, 60, True )

default_column_list_sort_lookup[ COLUMN_LIST_EXTERNAL_PROGRAMS.ID ] = ( COLUMN_LIST_EXTERNAL_PROGRAMS.PIPELINE_TYPE, True )
