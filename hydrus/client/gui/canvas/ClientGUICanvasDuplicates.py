...
class PotentialDuplicatePairFactoryDBGroupMode( PotentialDuplicatePairFactoryDB ):
    ...
    def DoSearchWork( self, *args ) -> bool:
        ...
        if len( self._group_media_ids ) == 0:
            ...
            self._potential_duplicate_id_pairs_and_distances_still_to_search.NotifyWorkTimeForAutothrottle( time_it_took, 0.5 )
...
class PotentialDuplicatePairFactoryDBMixed( PotentialDuplicatePairFactoryDB ):
    ...
    def DoSearchWork( self, *args ) -> bool:
        ...
        potential_duplicate_media_result_pairs_and_distances = CG.client_controller.Read( 'potential_duplicate_media_result_pairs_and_distances_fragmentary', self._potential_duplicates_search_context, block_of_id_pairs_and_distances, no_more_than = no_more_than )
        ...
        for row in potential_duplicate_media_result_pairs_and_distances.IterateRows():
            ...
            if len( self._fetched_media_result_pairs_and_distances ) >= no_more_than:
    ...
    def SearchWorkIsDone( self ):
        ...
        max_num_we_want = CG.client_controller.new_options.GetInteger( 'duplicate_filter_max_batch_size' )
        
        we_have_enough = len( self._fetched_media_result_pairs_and_distances ) >= max_num_we_want
...
class CanvasFilterDuplicates( ClientGUICanvas.CanvasWithHovers ):
    ...
    def __init__( self, parent, potential_duplicate_pair_factory: PotentialDuplicatePairFactory ):
    ...
    def _PresentFactoryPairs( self ):
        ...
        if len( media_result_pairs_and_distances ) == 0:
            ...
            skip_message = isinstance( self._potential_duplicate_pair_factory, PotentialDuplicatePairFactoryMediaResults )
            ...
            if num_remaining == 0:
                ...
                if num_committable + num_deletable > 0:
                    ...
                    if we_saw_a_non_auto_skip:
                        ...
                        if isinstance( self._potential_duplicate_pair_factory, PotentialDuplicatePairFactoryDBGroupMode ):
