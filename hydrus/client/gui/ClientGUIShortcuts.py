...
SHORTCUTS_MEDIA_VIEWER_ACTIONS = [
    ...
    CAC.SIMPLE_THISWINDOW_ALWAYS_ON_TOP_FLIP,
    CAC.SIMPLE_THISWINDOW_ALWAYS_ON_TOP_ON,
    CAC.SIMPLE_THISWINDOW_ALWAYS_ON_TOP_OFF,
    CAC.SIMPLE_THISWINDOW_FRAMELESS_FLIP
]
