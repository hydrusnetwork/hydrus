...
IMAGES = { IMAGE_JPEG, IMAGE_PNG, IMAGE_BMP, IMAGE_WEBP, IMAGE_TIFF, IMAGE_ICON, IMAGE_SVG }
...
FILES_THAT_CAN_HAVE_PIXEL_HASH = set( IMAGES ).union( { IMAGE_GIF } ).difference( { IMAGE_SVG } )
FILES_THAT_HAVE_PERCEPTUAL_HASH = set( IMAGES ).difference( { IMAGE_SVG } )
