...
FILES_THAT_CAN_HAVE_ICC_PROFILE = { IMAGE_BMP, IMAGE_JPEG, IMAGE_JXL, IMAGE_TIFF, IMAGE_PNG, IMAGE_GIF, APPLICATION_PSD, IMAGE_AVIF, IMAGE_AVIF_SEQUENCE }.union( PIL_HEIF_MIMES )
FILES_THAT_CAN_HAVE_EXIF = { IMAGE_JPEG, IMAGE_JXL, IMAGE_TIFF, IMAGE_PNG, IMAGE_WEBP, ANIMATION_JXL, ANIMATION_APNG, ANIMATION_WEBP, IMAGE_AVIF, IMAGE_AVIF_SEQUENCE }.union( PIL_HEIF_MIMES )
FILES_THAT_CAN_HAVE_XMP = { IMAGE_JPEG, IMAGE_TIFF, IMAGE_PNG, IMAGE_WEBP, ANIMATION_WEBP, ANIMATION_APNG, IMAGE_AVIF, IMAGE_AVIF_SEQUENCE }.union( PIL_HEIF_MIMES ) # apparently pdf and svg and other gubbins, but we'd need non-PIL handling obviously
FILES_THAT_CAN_HAVE_IPTC = { IMAGE_JPEG, IMAGE_TIFF }
...
FILES_THAT_CAN_HAVE_SOFTWARE_SOURCE = set( FILES_THAT_CAN_HAVE_HUMAN_READABLE_EMBEDDED_METADATA )
