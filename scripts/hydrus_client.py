...
try:
    ...
    from hydrus.include import HydrusPy2To3

    import wx

    HydrusPy2To3.do_2to3_test( wx_error_display_callable = wx.SafeShowMessage )

    from hydrus.include import HydrusExceptions
    from hydrus.include import HydrusConstants as HC
    from hydrus.include import HydrusData
    from hydrus.include import HydrusPaths

    import os
    import sys
    import time

    from hydrus.include import ClientController
    import threading
    from hydrus.include import HydrusGlobals as HG
    from hydrus.include import HydrusLogger
    import traceback
