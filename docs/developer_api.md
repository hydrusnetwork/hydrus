...
_Gets the data from database->how boned am I?. This is a simple Object of numbers for advanced purposes. Useful if you want to show some or record some stats. The numbers are the same as the dialog shows, so double check that to confirm what each value is for._
